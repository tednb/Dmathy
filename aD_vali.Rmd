...
```{r figure}
pdf("vali_64.pdf", width=12,height=6)
par(mfrow=c(1,2),mar=c(4,4,4,4))
smoothScatter(hep$ex.Hep, hep$va.Hep, xlab = " t(Hep:DiscoverySet)", 
              ylab = "t(Hep:Validation Set)", 
              xlim = c(-7,7), ylim = c(-7,7), cex = 1.5, 
              main = "Validation plot of age-DMCTs of Hepatocyte")
abline(v = 0, lty = 2, col = "black")
abline(h = 0, lty = 2, col = "black")
abline(v = fdr_threshold_ex_h, lty = 2, col = "blue")
abline(v = -fdr_threshold_ex_h, lty = 2, col = "blue")
abline(h = threshold_va, lty = 2, col = "blue")
abline(h = -threshold_va, lty = 2, col = "blue")
text(-6.5, 6.7, paste0("OR = ",OR_h),cex = 1,adj=c(0, 0))
text(-6.5, 6, paste0("p = ",pval_h),cex = 1,adj=c(0, 0))

text(-4.5,3.5,m_h[1,2],cex = 0.7,adj=c(0, 0),col = "red")
text(4.5,-3.5,m_h[2,1],cex = 0.7,adj=c(0, 0),col = "red")

text(5.5,4.5,m_h[1,1],cex = 0.7,adj=c(0, 0),col = "red")
text(-5.5,-4.5,m_h[2,2],cex = 0.7,adj=c(0, 0),col = "red")
smoothScatter(chol$ex.Chol, chol$va.Chol, xlab = " t(Chol:DiscoverySet)", 
              ylab = "t(Chol:Validation Set)", 
              xlim = c(-7,7), ylim = c(-7,7), cex = 1.5, 
              main = "Validation plot of age-DMCTs of Cholangiocyte")
abline(v = 0, lty = 2, col = "black")
abline(h = 0, lty = 2, col = "black")
abline(v = fdr_threshold_ex_ch, lty = 2, col = "blue")
abline(v = -fdr_threshold_ex_ch, lty = 2, col = "blue")
abline(h = threshold_va, lty = 2, col = "blue")
abline(h = -threshold_va, lty = 2, col = "blue")
text(-6.5, 6.7, paste0("OR = ",OR_ch),cex = 1,adj=c(0, 0))
text(-6.5, 6, paste0("p = ",pval_ch),cex = 1,adj=c(0, 0))

text(-4.5,3.5,m_ch[1,2],cex = 0.7,adj=c(0, 0),col = "red")
text(4.5,-3.5,m_ch[2,1],cex = 0.7,adj=c(0, 0),col = "red")
text(5.5,4.5,m_ch[1,1],cex = 0.7,adj=c(0, 0),col = "red")
text(-5.5,-4.5,m_ch[2,2],cex = 0.7,adj=c(0, 0),col = "red")
dev.off()
```
